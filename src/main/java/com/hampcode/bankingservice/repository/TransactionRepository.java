...
public interface TransactionRepository extends JpaRepository<Transaction,Long> {
    ...
    @Query("SELECT t FROM Transaction t WHERE t.sourceAccount.customer.email = :email OR t.targetAccount.customer.email = :email")
    List<Transaction> findByCustomerId(@Param("email") String email);
