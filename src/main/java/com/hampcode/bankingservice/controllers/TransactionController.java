...
public class TransactionController {
    ...
    @GetMapping("/customer")
    public ResponseEntity<List<TransactionResponseDTO>> getTransactionsByCustomerId() {
        List<TransactionResponseDTO> transactions = transactionService.getTransactionsByCustomerId();
        return new ResponseEntity<>(transactions, HttpStatus.OK);
    }
